...
# Use proportionality for reward
...
def reward_function(salamander_velocity_x):
    # Proportional reward: Larger velocity gets a larger reward
    if salamander_velocity_x > 0:
        reward = 0.1 * salamander_velocity_x  # Reward proportional to forward velocity
    else:
        reward = -0.1 * abs(salamander_velocity_x)  # Penalize backward movement more strongly
    return reward
