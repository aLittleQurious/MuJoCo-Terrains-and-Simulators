...
xml_file = "rocky_terrain_scene.xml"
n = 1000 #number
...
def append_rocks(xml_file, n, size_range, scatter_range, height_range, quat_range):
    ...
    for i in range(n):
        ...
        rock_position = scatter_position.append(height_position)
    ...
    tree.write("modified_" + xml_file)
    print(f"Appended {n} rocks to {xml_file} and saved as modified_{xml_file}.")
    

    
if __name__ == "__main__":
    append_rocks(xml_file, n, size_range, scatter_range, height_range, quat_range)